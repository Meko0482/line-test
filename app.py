...
def weather():
        city = request.json.get('city')  # 從請求中獲取城市名稱
    ...
    if city:
        ...
        return {'error': '請提供城市名稱。'}

def fetch_weather_data(city):
    # 氣象局 API 的 URL
    url = f"https://opendata.cwa.gov.tw/api/v1/rest/datastore/O-A0003-001?Authorization=CWA-7A752AE1-2953-4680-A2BA-6B1B13AAB708&format=JSON&StationId={city}"
